...
Conform::Core::IO::Command - Optus Internet Engineering common utility functions

=head1 SYNOPSIS

    use Conform::Core::IO::Command qw(:all :deprecated :oiehandlers);

    $Conform::Core::IO::Command::debug          = $debug;
    $Conform::Core::IO::Command::safe_mode      = $safe_mode;
    $Conform::Core::IO::Command::safe_write_msg = $message;
    $log_messages = $Conform::Core::IO::Command::log_messages;
...
=item B<$Conform::Core::IO::Command::safe_mode>
...
=item B<$Conform::Core::IO::Command::safe_write_msg>
...
sub action {
    ...
    $code and ref $code eq 'CODE'
      or croak 'Usage: Conform::Core::IO::Command::action($message, \&code, @args)';
...
sub safe {
    $_[0] and ref $_[0] eq 'CODE'
      or croak 'Usage: Conform::Core::IO::Command::safe(\&code, @args)';
    action '' => @_;
}
...
sub slurp_file {
    my $filename = shift;
    defined $filename
      or croak 'Usage: Conform::Core::IO::Command::slurp_file($filename)';
...
sub slurp_http {
    ...
    defined $uri and ref $flags eq 'HASH'
      or croak 'Usage: Conform::Core::IO::Command::slurp_http($uri, \%flags)';
...
sub safe_write {
    defined $_[0]
      or croak 'Usage: Conform::Core::IO::Command::safe_write($filename, @lines, \%flags)';
...
sub safe_write_file {
    ...
    defined $filename
      or croak
      'Usage: Conform::Core::IO::Command::safe_write_file($filename, @lines, \%flags)';
...
sub set_attr {
    ...
    defined $filename and $flags and ref $flags eq 'HASH'
      or croak 'Usage: Conform::Core::IO::Command::set_attr($filename, \%flags)';
...
sub text_install {
    ...
    defined $filename and defined $text and ref $flags eq 'HASH'
      or croak
      'Usage: Conform::Core::IO::Command::text_install($filename, $text, $cmd, \%flags)';
...
sub file_install {
    ...
    defined $filename and defined $source and ref $flags eq 'HASH'
      or croak
'Usage: Conform::Core::IO::Command::file_install($filename, $source, $cmd, \%flags, @expr)';
...
sub http_install {
    ...
    defined $filename and defined $uri and ref $flags eq 'HASH'
      or croak
'Usage: Conform::Core::IO::Command::http_install($filename, $uri, $cmd, \%flags, @expr)';

    if ( $filename =~ m/^\Q@{[HTTP_CACHE]}/ ) {
        _deprecated http_install =>
          'Conform::Core::IO::Command::http_install should not be used to write to HTTP cache';
        return 1;
    }
...
sub __dir_list_filtered {
    ...
    defined $handle
      or die "Conform::Core::IO::Command::dir_list error opendir error :$!";
...
sub _dir_list {
    ...
    $path and ref $flags eq 'HASH'
      or croak "usage: Conform::Core::IO::Command::dir_list (\$path, [\\\%flags])";
...
sub dir_list_http {
    ...
    $scheme and $host and $path
      or croak
      "Conform::Core::IO::Command::dir_list_http: $uri is invalid or is not a directory";
...
sub file_append {
    ...
    my ($regex_qm) = quotemeta($regex);    # handles \040 in fstab, SIR43953
      ...
      or croak
'Usage: Conform::Core::IO::Command::file_append($filename, $line, $regex, $cmd, $create)';
...
sub file_modify {
    ...
    defined $filename
      or croak 'Usage: Conform::Core::IO::Command::file_modify($filename, $cmd, @expr)';
...
sub file_unlink {
    ...
    defined $filename and ref $flags eq 'HASH'
      or croak 'Usage: Conform::Core::IO::Command::file_unlink($filename, $cmd, \%flags)';
...
sub file_comment_spec {
    ...
    defined $filename and defined $comment
      or croak
'Usage: Conform::Core::IO::Command::file_comment_spec($filename, $comment, $cmd, @regex)';
...
sub file_comment {
    my $filename = shift;
    defined $filename
      or croak 'Usage: Conform::Core::IO::Command::file_comment($filename, $cmd, @regex)';
...
sub file_uncomment_spec {
    ...
    defined $filename and defined $comment
      or croak
'Usage: Conform::Core::IO::Command::file_uncomment_spec($filename, $comment, $cmd, @regex)';
...
sub file_uncomment {
    my $filename = shift;
    defined $filename
      or croak 'Usage: Conform::Core::IO::Command::file_uncomment($filename, $cmd, @regex)';
...
sub dir_check {
    ...
    defined $dirname and $dirname =~ m/\S+/
      or croak 'Usage: Conform::Core::IO::Command::dir_check($dirname, $cmd, \%flags)';
...
sub dir_install {
    ...
    defined $dirname and defined $source
      or croak
'Usage: Conform::Core::IO::Command::dir_check($dirname, $source, $cmd, \%flags, @expr)';
...
sub dir_install_http {
    ...
    defined $dirname and defined $source
      or croak
'Usage: Conform::Core::IO::Command::dir_install_http ($dirname, $source, [$cmd, \%flags, @expr])';
...
sub symlink_check {
    ...
    defined $target and defined $symlink and ref $flags eq 'HASH'
      or croak 'Usage: Conform::Core::IO::Command::symlink_check($target, $symlink, \%flags)';
...
sub x509_cert {
    ...
    defined $cert and defined $key and ref $attr eq 'HASH'
      or croak 'Usage: Conform::Core::IO::Command::x509_cert($cert, $key, \%attr)';
...
sub warning {
    _deprecated warning =>
      "Conform::Core::IO::Command::warning is deprecated; use warn instead";
    carp @_;
    ();
}

sub scream {
    _deprecated scream => "Conform::Core::IO::Command::scream is deprecated; use die instead";
    croak @_;
}
...
sub file_install_http {
    ...
    _deprecated
      file_install_http =>
      "Conform::Core::IO::Command::file_install_http(\$uri, \$filename) is deprecated;\n",
      "use Conform::Core::IO::Command::http_install(\$filename, \$uri, ...) instead\n",
...
sub inetd_service {
    _deprecated inetd_service => 'Conform::Core::IO::Command::inetd_service is deprecated';
    croak 'Conform::Core::IO::Command::inetd_service: No replacement function available';
}
